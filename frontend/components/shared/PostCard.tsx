...
export const PostCard = ({ 
  ...
  return (
    <Link href={`/blog/${id}`} className="block group cursor-pointer">
      {/* Ripped out duplicate article tag for semantic HTML compliance */}
      <article className="flex flex-col overflow-hidden rounded-xl border border-[#d2d2da] bg-white h-full transition-all duration-200 group-hover:-translate-y-1 hover:shadow-lg">
